...
public class SystemConfiguration {
    ...
    public static void configure(final String filename) {
        try {
            ...
            WakfuProxy.getInstance().getLogger().error((Object)("Erreur lors du chargement du fichier de propri\u00e9t\u00e9s : " + filename), (Throwable)e);
        }
        catch (RuntimeException e2) {
            WakfuProxy.getInstance().getLogger().error((Object)("Erreur lors du chargement du fichier de propri\u00e9t\u00e9s : " + filename), (Throwable)e2);
        }
    }
