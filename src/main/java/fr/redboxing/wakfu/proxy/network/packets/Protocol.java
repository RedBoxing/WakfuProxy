...
public class Protocol {
    ...
    public Protocol() {
        ...
        register(514, PacketRequestRSA.class);
        register(401, PacketRSAResult.class);
        register(367, PacketSetIP.class);
        register(503, PacketAuthentication.class);
    ...
    public Packet getPacket(int id) throws InstantiationException, IllegalAccessException {
        ...
        return PACKETS_MAP.get(id).newInstance();
    }
