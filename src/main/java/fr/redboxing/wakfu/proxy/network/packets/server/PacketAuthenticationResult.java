...
public class PacketAuthenticationResult extends Packet {
    ...
    private LocalAccountInformations accountInformations;

    public PacketAuthenticationResult(LoginResponseCode code, int banDuration, LocalAccountInformations accountInformations) {
    ...
    public LocalAccountInformations getAccountInformations() {
        return accountInformations;
    }

    public void setAccountInformations(LocalAccountInformations accountInformations) {
        this.accountInformations = accountInformations;
    }
